...
<div class="main">
    <div class="main_left">
        <table>
            <tbody>
            <tr>
                <td width="134"><img src="<%=request.getContextPath()%>/resource/img/follow/follow_camera.jpg"/> <span
                        id="blog_count"></span>个照片说说
                </td>
                <td></td>
            </tr>
            <tr>
                <td><img src="<%=request.getContextPath()%>/resource/img/head.jpg" width="84" height="86"/></td>
                <td></td>
            </tr>
            </tbody>
        </table>
        ...
        <div class="user_all" style="display:none" id="user_all">
            ...
            <div class="user_info">
                <table width="243" height="40" class="user_table">
                    <tbody>
                    <tr>
                        <td name="name">scofield</td>
                        <td name="sex">男</td>
                        <td><input type="button" value="移除粉丝" name="action"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
